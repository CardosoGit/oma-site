...
class Clientes extends CI_Controller{
	...
	public function novo(){
		$this->load->template_panel('clientes/novo');
	}

	public function editar(){
		$this->load->model("usuarios_model");
		$cliente = $this->usuarios_model->getUser($this->input->post("ID_cliente"));
		$this->load->template_panel('clientes/editar', $cliente);
	}
	...
	public function  salvar(){
		...
		if($this->usuarios_model->salva($dados)){
			$this->load->template_panel('clientes/finaliza', array("success"=> "Cliente Cadastrado com sucesso")  );
		}else{
			$this->load->template_panel('clientes/finaliza', array("error"=> "Erro ao Cadastrar Cliente")  );
		}
	}
	...
	public function lista(){
 		...
 		//var_dump($dados);
 		$this->load->template_panel('clientes/lista', $dados);
 	}
