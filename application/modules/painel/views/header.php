...
<head>
  ...
  <title>Admin | OMA Informática</title>
  ...
  <link rel="stylesheet" href="<?= base_url()?>dist/css/AdminLTE.min.css">
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>plugins/jQueryUI/jquery-ui.min.css">
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>css/painel/style.css">
        ...
        <div class="wrapper">
          ...
          <header class="main-header">
            ...
            <a href="<?= base_url()?>index2.html" class="logo">
              ...
              <span class="logo-lg"><b>OMA</b></span>
            </a>
              ...
              <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown notifications-menu">
                    ...
                    <ul class="dropdown-menu">
                      <li class="header">Você não tem novos pedidos</li>
                      <li>
                        <!-- inner menu: contains the actual data -->
                        <ul id="notificacoes" class="menu">
                  ...
                  <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      ...
                      <span class="hidden-xs">Joao logado</span>
                    </a>  
                    <ul class="dropdown-menu">
                      <!-- User image -->
                      ...
                      <li class="user-footer">
                        ...
                        <div class="pull-right">
                          <a href="<?= base_url('Usuarios/sair') ?>" class="btn btn-default btn-flat">Sair</a>
                        </div>
                      </li>
                    </ul>
                  </li>
