...
//Controla as ordens de serviço
 class Ordemservico extends CI_Controller{
 	...
 	public function novo(){
 		$this->load->admin('ordem_servico/novo');
 	}

 	public function lista(){
 		$this->load->model('os_model');
 		$dados = array('os' => $this->os_model->getAll() );
 		$this->load->admin('ordem_servico/lista', $dados);
 	}
 	...
 	public function cadastrar(){
 		...
 		if($this->os_model->salva($this->input->post())){
 			$this->load->admin('ordem_servico/sucess');
 		}
 	}
 	...
 	public function editar(){
 		...
 		$this->load->admin('ordem_servico/editar',$os);
 	}
