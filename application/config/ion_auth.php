 ...
 */
$config['site_title']                 = "oma.inf.br";       // Site Title, example.com
$config['admin_email']                = "joao@oma.inf.br"; // Admin Email, admin@example.com
 ...
 */
$config['email_activate'] = 'ativar.php';
 ...
 */
$config['email_forgot_password'] = 'relembrar_senha.php';
 ...
 */
$config['email_forgot_password_complete'] = 'nova_senha.php';
